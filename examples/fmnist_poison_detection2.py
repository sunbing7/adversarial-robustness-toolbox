...
def main():
    ...
    '''
    model = load_model('/Users/bing.sun/workspace/Semantic/PyWorkplace/adversarial-robustness-toolbox/examples/fmnist2/fmnist_semantic_6_attack.h5')

    classifier = KerasClassifier(model=model, clip_values=(min_, max_))

    #classifier.fit(x_train, y_train, nb_epochs=10, batch_size=128)

    #classifier.save('mnist_1.h5')
    ...
    sprites_by_class = defence.visualize_clusters(x_train_c, "fmnist_poison_demo2")
    ...
    for n_class in range (0, 10):
        ...
        try:
            ...
            #plt.show()
            plt.savefig("fmnist2/Class " + str(n_class) + " cluster: 0" + ".png")
            plt.imshow(sprites_by_class[n_class][1])
            plt.title("Class " + str(n_class) + " cluster: 1")
            #plt.show()
            plt.savefig("fmnist2/Class " + str(n_class) + " cluster: 1" + ".png")
        except ImportError:
